      ...
      <section className="flex-grow flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 pt-20 md:pt-24">
        ...
        <div className="space-y-6 sm:space-y-8 max-w-3xl w-full">
          <div className="bg-gray-800 p-4 sm:p-6 rounded-lg">
            <h3 className="text-xl sm:text-2xl font-semibold text-white">Project A</h3>
            <p className="text-gray-400 mt-2 text-sm sm:text-base">A short description of your first project.</p>
          </div>
          <div className="bg-gray-800 p-4 sm:p-6 rounded-lg">
            <h3 className="text-xl sm:text-2xl font-semibold text-white">Project B</h3>
            <p className="text-gray-400 mt-2 text-sm sm:text-base">A short description of your second project.</p>
          </div>
        </div>
        <Link href="/contact">
          <button
